...
import "contracts/interfaces/IArbitrageV2.sol";
...
contract ArbitrageV2 is IArbitrageV2, ReentrancyGuard, Ownable {
  ...
  /// @inheritdoc IArbitrage
  function executeArbitrage() public override nonReentrant onlyArbitrager returns (uint256) {
